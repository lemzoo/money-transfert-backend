from broker_rabbit.exceptions import ExchangeNameDoesntMatch, ChannelDoesntExist, ExchangeNotDefinedYet
...
class ExchangeHandler:
    ...
    def __init__(self, channel, exchange_name='SI-AEF', type_exchange='direct',
